...
class SAM2(nn.Module):
    def __init__(self, n_feat, kernel_size, bias, in_c=3):
        super().__init__()
        self.conv = conv(n_feat, in_c, kernel_size, bias)

    def forward(self, x, x_img):
        return self.conv(x) + x_img
...
class MPRNet(nn.Module):
    ...
    def forward(self, x3_img):
        ...
        s3 = self.clamp(stage3_img + x3_img)
        s2 = self.clamp(stage2_img)
        s1 = self.clamp(stage1_img)
        return [s3, s2, s1]


class MPRNet_s1(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=96, scale_unetfeats=48, scale_orsnetfeats=32, num_cab=8, kernel_size=3,
                 reduction=4, bias=False):
        super(MPRNet_s1, self).__init__()
...
class MPRNet_s2(nn.Module):
    def __init__(self, in_c=3, out_c=3, n_feat=96, scale_unetfeats=48, scale_orsnetfeats=32, num_cab=8, kernel_size=3,
                 reduction=4, bias=False,):
        super(MPRNet_s2, self).__init__()
        ...
        self.sam23 = SAM2(n_feat, kernel_size=1, bias=bias, in_c=in_c)
    ...
    def forward(self, x3_img):
        ...
        ## Apply SAM
        stage2_img = self.sam23(res2[0], x3_img)
...
class MPRNet_partial(nn.Module):
     def __init__(self, in_c=3, out_c=3, n_feat=96, scale_unetfeats=48, scale_orsnetfeats=32, num_cab=8, kernel_size=3,
                  reduction=4, bias=False,):
         super(MPRNet_partial, self).__init__()
         ...
         self.sam12 = SAM(n_feat, kernel_size=1, bias=bias)
         self.sam23 = SAM2(n_feat, kernel_size=1, bias=bias)
